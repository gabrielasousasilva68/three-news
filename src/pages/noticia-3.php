...
<body>
    ...
    <main>
        <article>
            <h2>Hipótese do Amor: o sucesso literário que vai ganhar vida nas telas</h2>
            <img src="../assets/imagens/hipotese do amor.png">
            <p>O fenômeno literário A Hipótese do Amor, da autora Ali Hazelwood, está prestes a conquistar um novo
                ...
                <br>
                <img src="../assets/imagens/hipotesedoamor2.png">
                <br>
    ...
    <h2><center>Digite seu comentário</center></h2>
    ...
    <footer>
        <img class="logo" src="../assets/imagens/logomarca.png">
        <p>&copy;Desenvolvido por: Three News - Todos os direitos reservados!
        </p>
    </footer>
